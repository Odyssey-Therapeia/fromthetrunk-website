  ...
  return (
    <div className="mx-auto w-full max-w-3xl space-y-10 px-6 py-16">
      <ScrollReveal className="space-y-4">
        ...
        <h1 className="font-serif text-4xl text-foreground">Return & Refund Policy</h1>
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
        <section className="space-y-3">
          ...
          <p>Every saree in our collection is a unique, pre-loved piece. Because of the nature of these items, we encourage you to review all product details, images, and provenance information carefully before purchasing.</p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>Email us at <a href="mailto:hello@fromthetrunk.com" className="text-primary underline">hello@fromthetrunk.com</a> with your order number and reason for return. Our team will review your request and provide instructions within 2 business days.</p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p>If you receive a damaged or incorrect item, please contact us within 48 hours of delivery with photographs. We will arrange a return at no cost to you and issue a full refund or replacement.</p>
        </section>
      </div>
    </div>
  );
