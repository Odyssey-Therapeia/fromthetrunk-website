...
export const importMap = {
  ...
  "/components/admin/DashboardOverview#DashboardOverview": DashboardOverview,
  "/components/admin/AdminLogo#AdminLogo": AdminLogo,
  "/components/admin/AdminIcon#AdminIcon": AdminIcon,
}
